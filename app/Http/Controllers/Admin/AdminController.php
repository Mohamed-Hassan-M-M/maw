...
class AdminController extends Controller
{
    ...
    {
        $roles = Role::whereNotIn('name', [ 'vendor', 'user'])->get();
    ...
    {
        $admins = User::whereRoleIs(['admin', 'super_admin'])
    ...
    {
        $roles = Role::whereNotIn('name', ['super_admin', 'admin', 'vendor', 'user'])->get();
    ...
    {
        $roles = Role::whereNotIn('name', ['super_admin', 'admin', 'user', 'vendor'])->get();
